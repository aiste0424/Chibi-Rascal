...
Player::Player(Screen& screen)
{
	...
	m_images[static_cast<int>(State::Idle)].SetSpriteDimension(100 * m_scalar, 84 * m_scalar);
	m_images[static_cast<int>(State::Idle)].SetImageDimension(5, 1, 500, 84);
	
	m_images[static_cast<int>(State::Death)].SetSpriteDimension(70 * m_scalar, 140 * m_scalar);
	m_images[static_cast<int>(State::Death)].SetImageDimension(20, 1, 1400, 140);

	m_images[static_cast<int>(State::Walk)].SetSpriteDimension(100 * m_scalar, 84 * m_scalar);
	m_images[static_cast<int>(State::Walk)].SetImageDimension(8, 1, 800, 84);

	m_images[static_cast<int>(State::Up)].SetSpriteDimension(74 * m_scalar, 80 * m_scalar);
	m_images[static_cast<int>(State::Up)].SetImageDimension(8, 1, 592, 80);

	m_images[static_cast<int>(State::Attack)].SetSpriteDimension(120 * m_scalar, 100 * m_scalar);
